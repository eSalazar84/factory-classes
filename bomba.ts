export class Bomba{
    ...
    getBomb(): string {
      ...
      getReadEquip(dataSearch: string, array: Bomba[]): any {
      ...
      getDeleteEquip(dataDelete: string, array: Bomba[]): any {
      ...
      getEditEquip(dataSearch: string, array: Bomba[], datoAcambiar: string) {
        const modificarDato:Bomba = this.getReadEquip(dataSearch, array);    
        if (modificarDato) {
